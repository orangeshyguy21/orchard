...
export const SendNotificationTool: AiToolEntry = {
	tool: {
		...
		function: {
			...
			description: [
				'Send a notification to the operator about a significant event.',
				'',
				'**When to use:**',
				...
				'- Metrics that are within expected ranges',
				'- Information the operator already receives from other tools',
				'',
				'**Severity guide:**',
				'- `info` — noteworthy but not urgent (e.g. new channel opened, version update detected)',
				'- `warning` — potential issue that may need attention (e.g. low peer count, elevated failures)',
