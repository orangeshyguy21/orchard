    ...
    const mock_mint_info = {
        nuts: {
            5: {
                disabled: false,
                methods: [
                    {unit: 'sat', method: 'bolt11', min_amount: 1, max_amount: 100000},
                ],
            },
        },
    };
            ...
            expect(eventLogService.createEvent).toHaveBeenCalledWith(
                expect.objectContaining({
                    ...
                    details: expect.arrayContaining([
                        expect.objectContaining({field: 'disabled', old_value: 'false', new_value: 'true', status: EventLogDetailStatus.SUCCESS}),
                        expect.objectContaining({field: 'min_amount', old_value: '1', new_value: '10', status: EventLogDetailStatus.SUCCESS}),
                        expect.objectContaining({field: 'max_amount', old_value: '100000', new_value: '50000', status: EventLogDetailStatus.SUCCESS}),
                    ]),
                }),
            );
        });
