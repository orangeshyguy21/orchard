...
describe('ApiEventLogService', () => {
    ...
    it('returns OrchardEventLog[] on success', async () => {
        const mock_event = {id: '1', actor_type: 'user', actor_id: 'u1', timestamp: 100, section: 'settings', section_id: null, entity_type: 'setting', entity_id: null, type: 'update', status: 'success', details: []};
