...
import { 
	TaprootAssetInfoResponse,
	TaprootAssetResponse,
 } from '@client/modules/tapass/types/taproot-assets.types';
/* Local Dependencies */
import {
	TAP_INFO_QUERY,
	TAP_ASSETS_QUERY,
} from './taproot-assets.queries';
...
export class TaprootAssetsService {
	...
	public get tap_info$(): Observable<TaprootAssetInfo | null> { return this.tap_info_subject.asObservable(); }
