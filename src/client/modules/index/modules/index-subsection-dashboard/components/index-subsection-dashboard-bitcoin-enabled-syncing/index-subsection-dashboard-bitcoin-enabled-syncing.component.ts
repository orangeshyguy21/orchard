...
@Component({
	selector: 'orc-index-subsection-dashboard-bitcoin-enabled-syncing',
	standalone: false,
	templateUrl: './index-subsection-dashboard-bitcoin-enabled-syncing.component.html',
	styleUrl: './index-subsection-dashboard-bitcoin-enabled-syncing.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IndexSubsectionDashboardBitcoinEnabledSyncingComponent implements OnInit {
