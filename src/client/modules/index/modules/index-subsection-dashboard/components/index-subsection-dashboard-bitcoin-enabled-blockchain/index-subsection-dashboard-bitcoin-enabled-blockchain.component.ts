...
import {BitcoinTargetBlockOption} from '@client/modules/index/modules/index-subsection-dashboard/types/bitcoin-target-block-option';
/* Local Dependencies */
import {possible_options} from './possible-options';

@Component({
	selector: 'orc-index-subsection-dashboard-bitcoin-enabled-blockchain',
	standalone: false,
	templateUrl: './index-subsection-dashboard-bitcoin-enabled-blockchain.component.html',
	styleUrl: './index-subsection-dashboard-bitcoin-enabled-blockchain.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IndexSubsectionDashboardBitcoinEnabledBlockchainComponent implements OnInit, AfterViewInit {
	...
	public target_options: BitcoinTargetBlockOption[] = [];
