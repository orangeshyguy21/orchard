...
@Component({
	selector: 'orc-index-subsection-dashboard-bitcoin-enabled-hotwallet',
	standalone: false,
	templateUrl: './index-subsection-dashboard-bitcoin-enabled-hotwallet.component.html',
	styleUrl: './index-subsection-dashboard-bitcoin-enabled-hotwallet.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IndexSubsectionDashboardBitcoinEnabledHotwalletComponent implements OnInit {
