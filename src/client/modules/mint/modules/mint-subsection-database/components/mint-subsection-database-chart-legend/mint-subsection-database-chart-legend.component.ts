...
@Component({
	selector: 'orc-mint-subsection-database-chart-legend',
	standalone: false,
	templateUrl: './mint-subsection-database-chart-legend.component.html',
	styleUrl: './mint-subsection-database-chart-legend.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MintSubsectionDatabaseChartLegendComponent implements OnChanges {
