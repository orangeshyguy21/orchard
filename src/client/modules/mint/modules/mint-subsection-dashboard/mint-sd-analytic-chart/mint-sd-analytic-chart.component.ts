...
@Component({
	selector: 'orc-mint-sd-analytic-chart',
	standalone: false,
	templateUrl: './mint-sd-analytic-chart.component.html',
	styleUrl: './mint-sd-analytic-chart.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MintSDAnalyticChartComponent implements OnChanges, OnDestroy {
