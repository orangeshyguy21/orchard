...
@NgModule({
	...
	imports: [CommonModule, MatIconModule, MatRippleModule, MatButtonModule, MatMenuModule, GraphicModule, BitcoinModule, EventModule],
	exports: [PrimaryNavComponent, SecondaryNavComponent, SecondaryNavItemComponent, SecondaryNavMoreComponent],
})
